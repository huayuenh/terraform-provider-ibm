...
description: |-
  Get information about cd_toolchain_tool_eventnotifications
subcategory: "Continuous Delivery"
---

# ibm_cd_toolchain_tool_eventnotifications

Provides a read-only data source to retrieve information about cd_toolchain_tool_eventnotifications. You can then reference the fields of the data source in other resources within the same configuration by using interpolation syntax.
...
Nested schema for **parameters**:
	* `instance_crn` - (String) The CRN of the Event Notifications service instance.
